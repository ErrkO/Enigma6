...
class EnigmaNet (threading.Thread):
    ...
    disconnect_key = "!!!!!!!!!!"   #this gets passed to end the conversation. 
    ...
    def disconnect(self):
        self.send_message(self.disconnect_key)
        self.connection_established = False
    ...
    def __start_server(self):
        ...
        while self.connection_established:
            try:
                ...
                #if the disconnect_key is recieved, the connection was closed by the other user
                if message.decode(encoding="utf-8", errors="strict") == self.disconnect_key: 
                    self.connection_established = False
    ...
    def __start_client(self):
        ...
        while self.connection_established:
            try:
                ...
                #if message = disconnect_key, the connection was closed by the other user
                if message.decode(encoding="utf-8", errors="strict") == self.disconnect_key:
                    self.connection_established = False
                    print("The other user has disconnected")
                    break
